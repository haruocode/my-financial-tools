...
test('じぶん銀行の残高参照', async ({ page }) => {
  ...
  await page1.locator('#customerNo1').fill(process.env.JIBUN_BANK_NO1);
  await page1.locator('#customerNo2').click();
  await page1.locator('#customerNo2').fill(process.env.JIBUN_BANK_NO2);
  await page1.locator('#loginPW').click();
  await page1.locator('#loginPW').fill(process.env.JIBUN_BANK_PASS);
